# Graph Report - /home/user/ProjetoClaudecode  (2026-06-19)
...
## Graph Freshness
- Built from commit: `34442281`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- [[_COMMUNITY_Documentação e Glossário do Projeto|Documentação e Glossário do Projeto]]
...
- [[_COMMUNITY_Auto-sync e Identidade do Repositório|Auto-sync e Identidade do Repositório]]
- [[_COMMUNITY_Framework de Risco Oculto|Framework de Risco Oculto]]
- [[_COMMUNITY_Plugins Desativados (claude mem, pw)|Plugins Desativados (claude mem, pw)]]
- [[_COMMUNITY_MCP GPT Maker|MCP GPT Maker]]

## God Nodes (most connected - your core abstractions)
1. `Módulo 5 — Modelos de Conteúdo` - 10 edges
2. `monitor` - 9 edges
3. `monitor/run.md — Orquestrador Principal` - 9 edges
4. `Relatório 06-aplicacao-negocio.md (2026-06-17)` - 9 edges
...
9. `Swarm Skill — Regras Obrigatórias de Segurança` - 7 edges
10. `RESUMO.md (2026-06-17)` - 7 edges
...
- `config/README.md` --references--> `monitor/run.md — Orquestrador Principal`  [EXTRACTED]
  config/README.md → monitor/run.md
...
### Community 0 - "Documentação e Glossário do Projeto"
Cohesion: 0.10
...
### Community 2 - "Monitoramento de Tendências e Exportação"
Cohesion: 0.21
...
### Community 3 - "Monitoramento Instagram e Benchmark"
Cohesion: 0.27
...
### Community 6 - "Auto-sync e Identidade do Repositório"
Cohesion: 0.33
...
## Knowledge Gaps
- **23 isolated node(s):** `swarm`, `claude mem`, `pw (playwright-pro plugin)`, `gpt maker (MCP gptmaker)`, `memory/glossary.md` (+18 more)
...
- **Why does `Relatório 06-aplicacao-negocio.md (2026-06-17)` connect `Modelos e Frameworks de Conteúdo` to `Monitoramento Instagram e Benchmark`, `Análise Top10 e Frameworks`, `Framework de Risco Oculto`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **Why does `monitor/run.md — Orquestrador Principal` connect `Monitoramento Instagram e Benchmark` to `Modelos e Frameworks de Conteúdo`, `Monitoramento de Tendências e Exportação`, `Análise Top10 e Frameworks`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **Why does `Relatório 03-benchmark.md (2026-06-17)` connect `Análise Top10 e Frameworks` to `Modelos e Frameworks de Conteúdo`, `Framework de Risco Oculto`?**
  _High betweenness centrality (0.006) - this node is a cross-community bridge._
- **What connects `swarm`, `claude mem`, `pw (playwright-pro plugin)` to the rest of the system?**
  _27 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Documentação e Glossário do Projeto` be split into smaller, more focused modules?**
