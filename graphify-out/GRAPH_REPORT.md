...
- [[_COMMUNITY_Tendências e Exportação|Tendências e Exportação]]
- [[_COMMUNITY_Monitoramento Instagram|Monitoramento Instagram]]
- [[_COMMUNITY_Modelos de Conteúdo|Modelos de Conteúdo]]
- [[_COMMUNITY_Aplicação ao Negócio|Aplicação ao Negócio]]
- [[_COMMUNITY_Benchmark Top 10|Benchmark Top 10]]
- [[_COMMUNITY_Discurso Anti-Automação|Discurso Anti-Automação]]
- [[_COMMUNITY_Risco de Agentes IA|Risco de Agentes IA]]
...
### Community 0 - "Tendências e Exportação"
Cohesion: 0.21
...
### Community 1 - "Monitoramento Instagram"
Cohesion: 0.31
...
### Community 2 - "Modelos de Conteúdo"
Cohesion: 0.27
...
### Community 3 - "Aplicação ao Negócio"
Cohesion: 0.32
...
### Community 5 - "Discurso Anti-Automação"
Cohesion: 0.67
...
### Community 6 - "Risco de Agentes IA"
Cohesion: 0.67
...
- **Why does `Relatório 06-aplicacao-negocio.md (2026-06-17)` connect `Aplicação ao Negócio` to `Modelos de Conteúdo`, `Discurso Anti-Automação`, `Risco de Agentes IA`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `monitor/run.md — Orquestrador Principal` connect `Monitoramento Instagram` to `Tendências e Exportação`, `Modelos de Conteúdo`, `Benchmark Top 10`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `Relatório 03-benchmark.md (2026-06-17)` connect `Benchmark Top 10` to `Modelos de Conteúdo`, `Aplicação ao Negócio`, `Discurso Anti-Automação`, `Risco de Agentes IA`?**
